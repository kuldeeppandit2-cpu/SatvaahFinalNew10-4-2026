...
BEGIN
  ...
  v_provider_id := gen_random_uuid(); v_trust_id := gen_random_uuid();
  INSERT INTO provider_profiles(id,display_name,business_name,taxonomy_node_id,city_id,tab,listing_type,phone,is_active,is_claimed,is_scrape_record,is_phone_verified,availability,scrape_source,scrape_external_id,geo_point,created_at,updated_at) VALUES(v_provider_id,'Dr. Venkat Rao Cardiology','Dr. Venkat Rao Cardiology',v_node_id,v_city_id,'expertise'::"Tab",'expertise'::"ListingType",'9876503001',true,true,false,true,'available'::"Availability",'test_seed','test_exp_e02',ST_SetSRID(ST_MakePoint(78.479,17.389),4326),NOW(),NOW()) ON CONFLICT(scrape_source,scrape_external_id) DO NOTHING;
  ...
  v_provider_id := gen_random_uuid(); v_trust_id := gen_random_uuid();
  INSERT INTO provider_profiles(id,display_name,business_name,taxonomy_node_id,city_id,tab,listing_type,phone,is_active,is_claimed,is_scrape_record,is_phone_verified,availability,scrape_source,scrape_external_id,geo_point,created_at,updated_at) VALUES(v_provider_id,'Dr. Priya Heart Clinic','Dr. Priya Heart Clinic',v_node_id,v_city_id,'expertise'::"Tab",'expertise'::"ListingType",'9876503002',true,true,false,true,'available'::"Availability",'test_seed','test_exp_e03',ST_SetSRID(ST_MakePoint(78.494,17.372),4326),NOW(),NOW()) ON CONFLICT(scrape_source,scrape_external_id) DO NOTHING;
  ...
  v_provider_id := gen_random_uuid(); v_trust_id := gen_random_uuid();
  INSERT INTO provider_profiles(id,display_name,business_name,taxonomy_node_id,city_id,tab,listing_type,phone,is_active,is_claimed,is_scrape_record,is_phone_verified,availability,scrape_source,scrape_external_id,geo_point,created_at,updated_at) VALUES(v_provider_id,'Apollo Heart Specialist','Apollo Heart Specialist',v_node_id,v_city_id,'expertise'::"Tab",'expertise'::"ListingType",'9876503003',true,false,false,true,'available'::"Availability",'test_seed','test_exp_e04',ST_SetSRID(ST_MakePoint(78.462,17.404),4326),NOW(),NOW()) ON CONFLICT(scrape_source,scrape_external_id) DO NOTHING;
  ...
  v_provider_id := gen_random_uuid(); v_trust_id := gen_random_uuid();
  INSERT INTO provider_profiles(id,display_name,business_name,taxonomy_node_id,city_id,tab,listing_type,phone,is_active,is_claimed,is_scrape_record,is_phone_verified,availability,scrape_source,scrape_external_id,geo_point,created_at,updated_at) VALUES(v_provider_id,'Dr. Anjali Cardiac Care','Dr. Anjali Cardiac Care',v_node_id,v_city_id,'expertise'::"Tab",'expertise'::"ListingType",'9876503004',true,true,false,true,'available'::"Availability",'test_seed','test_exp_e05',ST_SetSRID(ST_MakePoint(78.489,17.368),4326),NOW(),NOW()) ON CONFLICT(scrape_source,scrape_external_id) DO NOTHING;
